  ...
  <main>
    ...
    <form action="/addbook" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <label for="description">Description</label>
        <textarea id="description" name="description" required value="<?= $_SESSION['inputs']['description'] ?? '' ?>"></textarea>
      </div>

      <div class="form-group">
        <label for="image">Book Cover Image</label>
        <input type="file" id="image" name="uploaded-image" accept="image/*" required />
      </div>
      <section>
